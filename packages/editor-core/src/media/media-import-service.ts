/**
 * @fileoverview coordinates media import, metadata extraction, thumbnails, and proxies.
 *
 * Folder role: Media import, metadata extraction, transcoding/proxy fallback, GIF decoding, and waveform generation/rendering.
