/**
 * @fileoverview AssemblyScript FFT implementation compiled into WebAssembly.
 *
 * This file exports the low-level routines used by the runtime wrapper in
 * ../index.ts. Keep memory layout and function signatures compatible with that
 * loader whenever changing the transform implementation.
 */
