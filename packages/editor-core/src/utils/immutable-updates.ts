/**
 * @fileoverview helpers for updating nested data without mutating originals.
 *
 * Folder role: Small shared utilities for IDs, clamping, cloning, serialization, and immutable updates.
