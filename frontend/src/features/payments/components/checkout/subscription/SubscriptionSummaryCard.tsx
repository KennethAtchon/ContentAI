      ...
      <CardContent className="space-y-6">
        <div className="space-y-3">
          <div className="flex items-center justify-between text-base">
            <span className="text-muted-foreground">{t("account_tabs_subscription_short")}</span>
            <span className="font-medium">{tierConfig.name}</span>
          </div>
          <div className="flex items-center justify-between text-base">
            <span className="text-muted-foreground">{t("checkout_billing")}</span>
          ...
          {billingCycle === "annual" && savingsPercentage > 0 && (
            <div className="flex items-center justify-between text-base pt-2 border-t">
              <span className="text-muted-foreground">{t("checkout_annual_savings")}</span>
          ...
          {showTrial && (
            <div className="flex items-center justify-between text-base pt-2 border-t">
              <span className="text-muted-foreground">{t("checkout_trial_period")}</span>
              <Badge variant="secondary" className="bg-green-500/10 text-green-700">
        ...
        <div className="pt-4 border-t">
          <p className="text-sm text-muted-foreground mb-2">{t("checkout_accepted_payment_methods")}</p>
          <div className="flex items-center gap-2 flex-wrap">
            <Badge variant="outline" className="text-sm">Visa</Badge>
            <Badge variant="outline" className="text-sm">Mastercard</Badge>
            <Badge variant="outline" className="text-sm">Amex</Badge>
            <Badge variant="outline" className="text-sm">Stripe</Badge>
          </div>
        </div>
      </CardContent>
    </Card>
