import { FastForward, Pause, Play, Rewind, Scissors, SkipBack, SkipForward, Volume2 } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-0.5">
        <button title={t("editor_transport_jump_start")} className="transport-btn">
          <SkipBack size={14} />
        </button>
        ...
        <button title={t("editor_transport_jump_end")} className="transport-btn">
          <SkipForward size={14} />
        </button>
      </div>
