...
const sampleAssets = [
  { id: "asset-1", label: "Opening shot", type: "video" as TrackType, icon: Video },
  { id: "asset-2", label: "Product still", type: "video" as TrackType, icon: Image },
  { id: "asset-3", label: "Narration", type: "audio" as TrackType, icon: Music },
];
