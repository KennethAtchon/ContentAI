...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  // - Content is generated from controlled config prop and THEMES constant (not user input)
  // - Only CSS custom properties (--color-*) are injected, no executable code
  // - Chart config is validated by TypeScript and component props
  // - No user-provided data is directly inserted into the HTML
  return (
    <style
