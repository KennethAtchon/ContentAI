/**
 * @fileoverview declares upscaling settings, methods, and result types.
 *
 * Folder role: GPU-assisted frame upscaling pipeline, quality presets, and type definitions.
