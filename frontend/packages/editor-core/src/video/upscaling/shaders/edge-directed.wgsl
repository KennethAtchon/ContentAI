// @fileoverview WGSL edge-directed interpolation pass for preserving detail while upscaling.
//
// Folder role: WGSL shader modules for Lanczos scaling, edge detection, edge-directed interpolation, and sharpening.
