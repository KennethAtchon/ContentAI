// @fileoverview WGSL transform shader for placing and sampling video layers.
//
// Folder role: WGSL shader modules used by WebGPU video rendering for transforms, compositing, effects, blur, and border radius handling.
// Keep shader bindings in sync with the TypeScript pipeline that imports this module.
