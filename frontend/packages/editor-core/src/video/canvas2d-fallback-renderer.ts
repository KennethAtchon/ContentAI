/**
 * @fileoverview renders video compositions with Canvas2D when WebGPU is unavailable.
 *
 * Folder role: Video decode/playback/rendering, WebGPU/Canvas renderers, effects, transitions, masks, speed changes, multicam, tracking, caching, and frame buffering.
