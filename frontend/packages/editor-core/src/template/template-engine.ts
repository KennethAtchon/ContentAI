/**
 * @fileoverview applies templates and fills variables into projects/compositions.
 *
 * Folder role: Template application and variable substitution for reusable editor projects/compositions.
