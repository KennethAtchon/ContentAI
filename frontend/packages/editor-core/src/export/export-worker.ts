/**
 * @fileoverview runs export work off the main thread when worker execution is available.
 *
 * Folder role: Final render orchestration, export presets/settings, progress reporting, worker handoff, and downloadable output creation.
