/**
 * @fileoverview removes or masks image/video backgrounds for smart edit tools.
 *
 * Folder role: AI-assisted media transforms that can be layered into import, edit, or export workflows.
