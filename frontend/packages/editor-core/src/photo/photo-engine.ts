/**
 * @fileoverview coordinates photo editing operations and image processing.
 *
 * Folder role: Still-image editing pipeline with adjustments, photo operations, retouching tools, and image-specific types.
