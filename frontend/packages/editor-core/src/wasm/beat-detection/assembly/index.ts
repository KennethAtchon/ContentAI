/**
 * @fileoverview AssemblyScript beat-detection routines compiled into WebAssembly.
 *
 * This file performs the signal-processing kernels used by the runtime wrapper
 * in ../index.ts. Keep exported signatures stable because JavaScript callers
 * pass typed arrays directly into these routines.
 */
