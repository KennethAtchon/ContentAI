/**
 * @fileoverview AssemblyScript WAV encoder implementation compiled into WebAssembly.
 *
 * This file writes PCM samples into caller-provided byte buffers. Keep exported
 * function names, sample scaling, and buffer offset semantics aligned with the
 * runtime wrapper in ../index.ts.
 */
