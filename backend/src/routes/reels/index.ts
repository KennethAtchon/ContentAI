 ...
 */
reelsRouter.get("/", rateLimiter("customer"), authMiddleware("user"), async (c) => {
  try {
 ...
 */
reelsRouter.get("/:id", rateLimiter("customer"), authMiddleware("user"), async (c) => {
  try {
 ...
 */
reelsRouter.post("/scan", rateLimiter("customer"), authMiddleware("user"), async (c) => {
  try {
